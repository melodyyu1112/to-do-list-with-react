...
class Task extends React.Compoment {
    render() {
...
class ToDoList extends React.Component{
    constructor(props) {
        ...
        this.toggleComplete = this.toggleComplete(this);
        this.toggleFilter = this.toggleFilter(this);
    }
    ...
    fetchTasks(){
        fetch("https://altcademy-to-do-list-api.herokuapp.com/tasks?api_key=53")
        .then(checkStatus)
        .then(json)
        .then((response) => {
    ...
    deleteTask(id) {
        ...
        fetch(`https://altcademy-to-do-list-api.herokuapp.com/tasks/${id}?api_key=53`, {
        method: "DELETE",
        mode: "cors",
        }).then(checkStatus)
        .then(json)
